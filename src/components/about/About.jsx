    ...
    <div className="max-w-[1200px] mx-auto h-full p-4 mt-36">
      <div className="grid sm:grid-cols-2 sm:px-8 lg:grid-cols-3 gap-4 lg:h-[60vh]">
        <div data-aos="fade-right">
          ...
          >
            ...
            <p className="text-left text-lg lg:text-justify my-2 text-slate-500">
              ...
              Compartí con nustros instructores con más de 10 años de
              experiencia y formá un hermoso grupo de colegas pilotos.
              <br />
        ...
        <div data-aos="fade-left">
          <div className="bg-blue-700 h-full rounded-lg text-white  flex flex-col justify-between p-8 ">
            ...
            <p className="text-lg  text-justify">
              ...
              instruccion y acompañamiento para que logres tus metas en la
              hermosa carrera aeronáutica que elegiste.
              <br />
              ¡Sumate hoy!
            </p>
      ...
      <div
        data-aos="flip-up"
        className="  p-8 mt-24 grid md:grid-cols-2 lg:grid-cols-4 gap-4"
      >
